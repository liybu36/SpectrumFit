...
void rf208_convolution()
{
  ...
  RooRealVar ly_mean("ly_mean","LY Mean[PE/keV]",1);
  RooFormulaVar fmg("fmg","fmg","@0*@1",RooArgList(t,ly_mean));
  RooGaussian fgauss("fgauss","fgauss",t,fmg,sg) ;
  ...
  RooFFTConvPdf lxg("lxg","landau (X) gauss",t,landau,fgauss) ;
