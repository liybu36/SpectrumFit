...
public :
 ...
 SLADDSTSelector(TTree * /*tree*/ =0) : fChain(0),
     id(0),
     FullSpectrum(0),FullSpectrum_ntuple(0),C14Spectrum(0),Veto_TPC_hist(0),
     charge(0),height(0),width(0),Fulllate(0),Co60Spectrum(0)
     { }
 ...
 private:
   ...
   TH1F *id;
   TH1F *FullSpectrum, *Fulllate;
   TNtuple *FullSpectrum_ntuple;
   TH1F *C14Spectrum,*Co60Spectrum;
   TH2F *Veto_TPC_hist;
...
void SLADDSTSelector::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("tpc_jaosn_y", &tpc_jaosn_y, &b_tpc_jason_x);
