...
public :
   ...
   */
   Int_t           dep_pdg[10493];   //[ndeposits]
   Int_t           dep_mat[10493];   //[ndeposits]
   Int_t           dep_track[10493];   //[ndeposits]
   Double_t        dep_time[10493];   //[ndeposits]
   Float_t         dep_ene[10493];   //[ndeposits]
   Float_t         dep_step[10493];   //[ndeposits]
   Float_t         dep_x[10493];   //[ndeposits]
   Float_t         dep_y[10493];   //[ndeposits]
   Float_t         dep_z[10493];   //[ndeposits]
   Float_t         dep_r[10493];   //[ndeposits]
   /*
 ...
 reconSelector(TTree * /*tree*/ =0) : fChain(0),
     ...
     fFile(0),fProofFile(0), ReconTree(0), recon_evts(0), currentHit(),event_pdg(0),event_broken(0)
     { }
